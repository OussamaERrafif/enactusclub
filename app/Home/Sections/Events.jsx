...
const Events = () => {
  return (
    <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 ">
      ...
      <div className="flex flex-col items-center gap-6 lg:gap-8 xl:gap-10 min-w-full min-h-full">
        <Imgh className="lg:w-1/2 md:w-full sm:w-full" src={project1} alt={"a1"} title={"Enactus Days"} />
