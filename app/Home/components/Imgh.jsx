...
const Imgh = ({ src, alt, title }) => {
  ...
  return (
    <div
      className='flex flex-col max-w-full sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl rounded overflow-hidden shadow-lg transition-transform duration-500 ease-in-out relative m-4 sm:m-8 md:m-10 lg:m-12 xl:m-16'
    ...
    >
      ...
      {isHovered && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 z-10">
          <h1 className='text-white text-3xl font-bold m-4 sm:m-6 md:m-8 lg:m-10 xl:m-12 border-4 p-2 border-yellow-300'>{title}</h1>
